<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminDeneyimGuncelle.aspx.cs" Inherits="Cv_Blok.AdminDeneyimGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
      ...
      <form id="form1" runat="server">
        <div class="forum">
            ...
            <asp:TextBox ID="TxtAltBasik" runat="server" CssClass="Txt"></asp:TextBox><p></p>
