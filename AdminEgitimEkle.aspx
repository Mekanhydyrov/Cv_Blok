<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminEgitimEkle.aspx.cs" Inherits="Cv_Blok.AdminEgitimEkle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <form id="form1" runat="server">
        <div class="forum">
            ...
            <asp:Button ID="BtnEgitimEkle" runat="server" CssClass="Btn" Text="Kaydet" OnClick="BtnEgitimEkle_Click"/>
        </div>
    </form>
